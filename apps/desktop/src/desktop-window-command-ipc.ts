...
export const PATCHER_DESKTOP_OPEN_NEW_TAB_CHANNEL = "bb-desktop:open-new-tab";
export const PATCHER_DESKTOP_APP_COMMAND_CHANNEL = "bb-desktop:app-command";
 ...
 */
export const PATCHER_DESKTOP_CLOSE_WINDOW_CHANNEL = "bb-desktop:close-window";
