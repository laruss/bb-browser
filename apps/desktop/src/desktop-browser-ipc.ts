...
export const PATCHER_DESKTOP_BROWSER_RELOAD_CHANNEL =
  "bb-desktop:browser:reload";
export const PATCHER_DESKTOP_BROWSER_STOP_CHANNEL = "bb-desktop:browser:stop";
...
export const PATCHER_DESKTOP_BROWSER_STATE_CHANNEL = "bb-desktop:browser:state";
...
export const PATCHER_DESKTOP_BROWSER_PRINT_CHANNEL = "bb-desktop:browser:print";
...
export const PATCHER_DESKTOP_BROWSER_ZOOM_CHANNEL = "bb-desktop:browser:zoom";
...
export const PATCHER_DESKTOP_BROWSER_FIND_CHANNEL = "bb-desktop:browser:find";
...
export const PATCHER_DESKTOP_BROWSER_POPUP_CHANNEL = "bb-desktop:browser:popup";
