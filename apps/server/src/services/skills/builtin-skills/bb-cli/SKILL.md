...
| [references/machines-projects.md](references/machines-projects.md) | `bb connect` remote access and port sharing, enrolled execution machines, projects and their sources, environments and diffs, providers/models/ACP agents, and the repo `.bb-env-setup.sh` hook |
