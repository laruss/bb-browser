...
const PROVISIONING_LINES: readonly string[] = [
  ...
  "[patcher-env-setup] Running: pnpm exec turbo run build --filter='./packages/*'",
  "@patcher/process-utils:build: cache hit, replaying logs",
  "@patcher/domain:build: cache hit, replaying logs",
  "@patcher/templates:build: cache hit, replaying logs",
  "@patcher/secret-storage:build: cache hit, replaying logs",
  "@patcher/hono-typed-routes:build: cache hit, replaying logs",
  "@patcher/config:build: cache hit, replaying logs",
  "@patcher/test-helpers:build: cache hit, replaying logs",
  "@patcher/db:build: cache hit, replaying logs",
  "@patcher/server-contract:build: cache hit, replaying logs",
  "@patcher/host-daemon-contract:build: cache hit, replaying logs",
  "@patcher/thread-view:build: cache hit, replaying logs",
...
const COMMAND_OUTPUT_CHUNKS: readonly string[] = [
  "• turbo 2.8.3\n",
  "• Packages in scope: @patcher/server, @patcher/core-ui, @patcher/domain, @patcher/thread-view, @patcher/server-contract, @patcher/host-daemon-contract\n",
  "• Running test in 6 packages\n",
  "• Remote caching disabled, using shared worktree cache\n",
  "@patcher/server:test: cache miss, executing 38ec9ac79a329473\n",
  "@patcher/server:test: > @patcher/server@0.0.1 test /Users/michael/.patcher-dev/worktrees/env_33i22gvcqe/bb/apps/server\n",
  "@patcher/server:test: > vitest run --config vitest.config.ts\n",
  "@patcher/server:test:  RUN  v4.1.1 /Users/michael/.patcher-dev/worktrees/env_33i22gvcqe/bb/apps/server\n",
  "@patcher/server:test:  ✓ test/public/public-thread-interactions.test.ts (11 tests) 347ms\n",
  "@patcher/server:test:  ✓ test/public/public-thread-data.test.ts (27 tests) 328ms\n",
  "@patcher/server:test:  ✓ test/public/public-thread-lifecycle-regressions.test.ts (12 tests) 373ms\n",
  "@patcher/server:test:  ✓ test/host-join-enroll.test.ts (16 tests) 451ms\n",
  "@patcher/server:test:  ✓ test/internal/internal-command-result-idempotency.test.ts (16 tests) 451ms\n",
  "@patcher/server:test:  ✓ test/internal/internal-event-side-effects.test.ts (16 tests) 508ms\n",
  "@patcher/server:test:  ✓ test/services/pending-interactions.test.ts (4 tests) 595ms\n",
  "@patcher/server:test:  ✓ test/public/public-thread-lifecycle-regressions.test.ts (12 tests) 580ms\n",
  "@patcher/server:test:  ✓ test/services/pending-interactions.test.ts (15 tests) 510ms\n",
  "@patcher/server:test:  ✓ test/public/public-projects-hosts.test.ts (23 tests) 654ms\n",
  "@patcher/server:test:  ✓ test/public/public-threads.environments.test.ts (21 tests) 653ms\n",
  "@patcher/server:test:  ✓ test/public/public-environments-system.test.ts (24 tests) 814ms\n",
  "@patcher/server:test:  ✓ test/internal/internal-session-correctness.test.ts (33 tests) 968ms\n",
  "@patcher/server:test:  ✓ test/public/public-thread-data.test.ts (27 tests) 979ms\n",
  "@patcher/server:test:  ✓ test/public/public-threads.steer.test.ts (18 tests) 712ms\n",
  "@patcher/server:test:  ✓ test/public/public-threads.send-and-steer.test.ts (24 tests) 1023ms\n",
  "@patcher/server:test:  ✓ test/threads/timeline-service.test.ts (52 tests) 1442ms\n",
  "@patcher/server:test:\n",
  "@patcher/server:test:  Test Files  66 passed (66)\n",
  "@patcher/server:test:       Tests  687 passed (687)\n",
  "@patcher/server:test:    Start at  21:54:38\n",
  "@patcher/server:test:    Duration  16.49s (transform 4.93s, setup 1.21s, collect 0ms, tests 14.21s)\n",
  "\n",
