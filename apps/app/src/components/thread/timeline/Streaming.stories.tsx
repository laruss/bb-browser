...
const COMMAND_OUTPUT_CHUNKS: readonly string[] = [
  ...
  "@patcher/server:test: > @patcher/server@0.0.1 test /Users/michael/.bb-dev/worktrees/env_33i22gvcqe/bb/apps/server\n",
  "@patcher/server:test: > vitest run --config vitest.config.ts\n",
  "@patcher/server:test:  RUN  v4.1.1 /Users/michael/.bb-dev/worktrees/env_33i22gvcqe/bb/apps/server\n",
