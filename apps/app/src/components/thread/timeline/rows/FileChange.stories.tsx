...
const baseProps = {
  ...
  workspaceRootPath: "/Users/michael/.patcher-dev/worktrees/env_story/bb",
};
...
// ---------------------------------------------------------------------------
// Real file-change rows pulled from live threads in ~/.patcher-dev/patcher.db.
//
...
const updateApiTypes: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.patcher-dev/worktrees/env_story/bb/packages/server-contract/src/api-types.ts",
    kind: "update",
    movePath: null,
...
const addFormatHelpersTest: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.patcher-dev/worktrees/env_story/bb/packages/thread-view/test/format-helpers.test.ts",
    kind: "add",
    movePath: null,
...
const largeRefactorComposer: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.patcher-dev/worktrees/env_story/bb/apps/app/src/views/ThreadFollowUpComposer.tsx",
    kind: "update",
    movePath: null,
...
const errorFileChange: TimelineRow = {
  ...
  status: "error",
  stderr:
    "ENOENT: no such file or directory, open '/Users/michael/.patcher-dev/worktrees/env_story/bb/packages/server-contract/src/api-types.ts'\n",
};
